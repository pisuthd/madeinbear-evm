...
import CollateralModal from '../components/markets/CollateralModal';
import { PRICES, formatUSD, calculateMaxBorrow } from '../utils/prices';

const LTV_PERCENT = 75; // 75% LTV

// Calculate health factor: (collateral_usd * LTV) / borrow_usd
...
export default function BorrowUSDT() {
  ...
  const maxBorrow = calculateMaxBorrow(userCollateral ?? 0n);
          ...
          {isLoading ? (
            ...
            <>
              ...
              >
                ...
                <div className="text-[#94a3b8] text-sm">cETH ({formatUSD(userCollateral ?? 0n, 'ETH')})</div>
              </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="bg-[#1e293b]/50 border border-[#f59e0b]/10 rounded-xl p-6">
            ...
            {isLoading ? (
              ...
              <>
                {/* Collateral Info - Clickable */}
                <div
                  onClick={() => setShowCollateralModal(true)}
                  className="mb-4 p-4 bg-[#0f172a]/50 rounded-lg cursor-pointer hover:bg-[#0f172a] transition-colors"
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <div>
                        <div className="text-[#94a3b8] text-sm">Locked Collateral</div>
              ...
              <>
                ...
                <div className="mb-4">
                  ...
                  <div className="text-[#94a3b8] text-sm mt-2 flex">
                    <div>
                      Borrowed: <span className="text-[#f8fafc]">{formatAmount(userBorrow)} cUSDT</span>
                    </div>
